...
public class ABM {
    ...
    public void alta() throws Exception {
        ...
        BigDecimal importReserva = new BigDecimal(1000);
        reserva.setImportReserva(importReserva); //Forma 1

        reserva.setImportTotal(new BigDecimal(3000));//Forma 2
        ...
        //ALTERNATIVO DE LEER FECHA CON TRY CATCH
        ...
        reserva.setEstadoPago(1);//En mi caso significa pagado
        reserva.setHuesped(huesped);//Esta es la relación biridireccional
       
        //Alctualizo todos los objetos
